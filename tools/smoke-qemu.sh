...
require_log "[m31] session service endpoint registered"
require_log "[tty] service endpoint registered"
require_log "[tty] input event path pass"
require_log "[m31] vfs stat/listdir path pass"
require_log "[boot] milestone 31 complete"
require_log "[boot] launching /init"
require_log "[scadekos] command runner started"
require_log "scadek:/> version"
require_log "SCDK: v0.4.0-alpha.2"
require_log "ScadekOS: v0.1.0-devpreview.2"
require_log "scadek:/> ls /"
require_log "scadek:/> cat /etc/scadekos.conf"
require_log "scadek:/> run /bin/hello"
require_log "[proc] spawn /bin/hello"
require_log "[scadekos] version 0.1.0-devpreview.2"
require_log "[hello] hello from ScadekOS"
require_log "scadek:/> rings"
require_log "scadek:/> grants"
require_log "scadek:/> services"
require_log "scadek:/> caps"
