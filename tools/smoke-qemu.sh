...
require_log "[scadekos] version 0.1.0-dev.2"
...
require_log "[scadekos] ring runtime console write"
require_log "[ring] user ring create pass"
require_log "[ring] submit batch 16"
require_log "[ring] completion batch 16 pass"
require_log "[boot] scadekos dev.2 complete"
require_log "[boot] milestone 24 complete"
